...
class OrderFacadeUnitTest extends MockTestSupport {
    ...
    void orderPayment() {
        ...
        CouponInfo.UsableCoupon mockUsableCoupon = mock(CouponInfo.UsableCoupon.class);
        ...
        when(couponService.getUsableCoupon(any())).thenReturn(mockUsableCoupon);
        ...
        inOrder.verify(couponService, times(1)).getUsableCoupon(criteria.toCouponCommand());
        ...
        inOrder.verify(couponService, times(1)).useUserCoupon(mockUsableCoupon.getUserCouponId());
