...
public class OrderFacade {
    ...
    public OrderResult.Order orderPayment(OrderCriteria.OrderPayment criteria) {
        ...
        OrderCommand.Create orderCommand = criteria.toOrderCommand(
            optionalUsableCoupon.map(CouponInfo.UsableCoupon::getUserCouponId).orElse(null),
        ...
        optionalUsableCoupon.ifPresent(coupon -> couponService.useUserCoupon(coupon.getUserCouponId()));
